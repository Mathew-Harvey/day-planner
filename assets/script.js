...
//---------------------------------------------------------------------------------------
    ...
    function colourRow9() {
        ...
        else if (time == "10" || "11" || "12" || "13" ||"14" || "15" || "16" || "17") {
...
//---------------------------------------------------------------------------------------
    ...
    function colourRow10() {
        ...
        else if (time == "11" || "12" || "13" || "14" || "15" || "16" || "17"||"18"||"19") {
...
//---------------------------------------------------------------------------------------
    ...
    function colourRow11() {
        ...
        else if (time ==  "9" || "10") {console.log(time)
...
//---------------------------------------------------------------------------------------
    ...
    function colourRow1() {
        ...
        else if (time == "9" || "10" || "11" || "12") {
            $("#onePmRow").addClass("future")
        }
        else if (time == "14" || "15" || "16" || "17") {
...
//---------------------------------------------------------------------------------------
    ...
    function colourRow2() {
        ...
        else if (time == "9" || "10" || "11" || "12"|| "13") {
            $("#twoPmRow").addClass("future")
        }
        else if (time == "15" || "16" || "17") {
...
//---------------------------------------------------------------------------------------
    ...
    function colourRow5() {
        ...
        else if (time == "9" || "10" || "11" || "12"|| "13" || "14" || "15") {
